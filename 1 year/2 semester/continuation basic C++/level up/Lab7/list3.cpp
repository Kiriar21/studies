...
void zapis(SAuto& mojNowyCar, ostream& out){
    out<<"Marka twojego samochodu: "<<mojNowyCar.marka<<endl;
    out<<"Model twojego samochodu: "<<mojNowyCar.model<<endl;
    out<<"Kolor twojego samochodu: "<<mojNowyCar.kolor<<endl;
    out<<"Liczba drzwi w twoim samochodzie: "<<mojNowyCar.liczbaDrzwi<<endl;
    out<<"Liczba koni mechanicznych w twoim samochodzie: "<<mojNowyCar.KM<<endl;
    out<<"Pojemnosc silnika w twoim samochodzie: "<<mojNowyCar.pojemnoscSilnika<<endl;
    out<<endl;
}
void zapis(SAuto* mojNowyCar, ostream& out){
    out<<"Marka twojego samochodu: "<<mojNowyCar->marka<<endl;
