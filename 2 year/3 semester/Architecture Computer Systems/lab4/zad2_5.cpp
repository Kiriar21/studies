...
int main()
{
    ...
    for (int i = 0; i < n; ++i)
        tab[i] = 0.1;    // wypełnianie tablicy
    double time;            // zmienne dla pomiaru czasu
    double s1 = 0.0, s2 = 0.0, s3 = 0.0, s4 = 0.0, s5 = 0.0, s6 = 0.0, s7 = 0.0, s8 = 0.0, s9 = 0.0, s10 = 0.0, s11 = 0.0, s12 = 0.0, s13 = 0.0, s14 = 0.0, s15 = 0.0, s16 = 0.0; // bufor dla sumy wszystkich elementów tablicy
