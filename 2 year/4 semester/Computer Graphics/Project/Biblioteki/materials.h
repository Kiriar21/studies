...
//////////////////////////////////////////////////////////////////////
// sta3e okre?laj1ce poszczególne materia3y
//////////////////////////////////////////////////////////////////////
enum mtlMaterial
{
    MTL_BRASS,              // mosi1dz
    MTL_BRONZE,             // br1z
    MTL_POLISHED_BRONZE,    // polerowany br1z
    MTL_CHROME,             // chrom
    MTL_COPPER,             // mied?
    MTL_POLISHED_COPPER,    // polerowana mied?
    MTL_GOLD,               // z3oto
    MTL_POLISHED_GOLD,      // polerowane z3oto
    MTL_PEWTER,             // grafit (cyna z o3owiem)
    MTL_SILVER,             // srebro
    ...
    MTL_BRIGHT_WHITE,       // jasny bia3y
    MTL_LESS_BRIGHT_WHITE,  // mniej jasny bia3y
    MTL_WARMISH_WHITE,      // ciep3y bia3y
    MTL_COOLISH_WHITE,      // zimny bia3y
    ...
    MTL_WHITE_PLASTIC,      // bia3y plastik
    MTL_YELLOW_PLASTIC,     // ?ó3ty plastik
    ...
    MTL_WHITE_RUBBER,       // bia3a guma
    MTL_YELLOW_RUBBER,      // ?ó3ta guma
    MTL_DEFAULT = -1        // materia3 domy?lny
};

//////////////////////////////////////////////////////////////////////
// sta3e okre?laj1ce poszczególne w3a?ciwo?ci materia3u
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// pobranie wybranej w3a?ciwo?ci okre?lonego materia3u
//////////////////////////////////////////////////////////////////////
inline const GLfloat *GetMaterial( const mtlMaterial material, const mtlMaterialProp properties )
{
    switch( material )
    {
        ...
        // materia3 - grafit (cyna z o3owiem)
        case MTL_PEWTER:
        ...
        // materia3 - niebieskozielony plastik
        ...
        // materia3 - niebieskozielona guma
...
//////////////////////////////////////////////////////////////////////
// pobranie angielskiej nazwy okre?lonego materia3u
//////////////////////////////////////////////////////////////////////
