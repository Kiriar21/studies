...
namespace zadanie1
{
    public class Player:Person
    {
        ...
        public Player(string name, string lname, DateTime date, string position, string club, int scoredGoals) : base(name,lname,date)
        {
            Position = position;
            Club = club;
        ...
        {
            Console.WriteLine($"{this._scoredGoals}");
            ScoredGoals++;
        }
    }
}
